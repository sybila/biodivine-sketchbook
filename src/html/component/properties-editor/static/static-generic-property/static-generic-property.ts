...
import style_less from './static-generic-property.less?inline'
import { icon } from '@fortawesome/fontawesome-svg-core'
import { faTrash } from '@fortawesome/free-solid-svg-icons'
import PropertyTile from '../../property-tile/property-tile'

@customElement('static-generic-property')
export default class StaticGenericProperty extends PropertyTile {
    ...
    return html`
      <div class="uk-flex uk-flex-column uk-margin-small-bottom">
        <div class="uk-flex uk-flex-row">
          <input id="name-field" class="uk-input uk-text-center" readonly value="${this.prop.name}"
